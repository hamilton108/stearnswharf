          ...
          , bt =
              W.WoodProfile
                ...
                , matr =
                    W.Material
                      W.Glulam
                      ( W.MaterialProperties{emodulus = 13500.0, mySigma = 32.0, myTau = 3.5, stClass = W.GL32c}
                      )
                }
          , limitStates =
              Just
        ...
        [ L.PointLoad
            ...
            , node =
                N.Node
                  ...
                  , nx = 1.75
                  , ny = 0.0
                  , dof = N.Dof{dofX = 1, dofY = 1, dofM = 1}
                  , globNdx = 1
                  }
            }
        ]
